...
public class User implements Serializable {
	...
	private static final long serialVersionUID = 649172131133687114L;
	...
	public String toString() {
		return "User [u_id=" + u_id + ", u_uuid=" + u_uuid + ", u_username=" + u_username + ", u_name=" + u_name
				+ ", u_password=" + u_password + ", u_email=" + u_email + ", u_r_id=" + u_r_id + ", u_images="
				+ u_images + ", u_remark=" + u_remark + ", u_update_time=" + u_update_time + ", u_del_flag="
				+ u_del_flag + "]";
	}
}
